...
local interfaces = {
  wlan_interface = User_prefs.network.wlan,
  lan_interface = User_prefs.network.ethernet
}
      ...
      awful.spawn.easy_async_with_shell(
        ...
        function(stdout)
          ...
          if healthy then
            ...
            update_tooltip("You are connected but have no internet\n" .. message)
          end
    ...
    local update_wireless_icon = function(strength)
      awful.spawn.easy_async_with_shell(
        ...
        function(stdout)
          ...
          network_widget.container.network_layout.icon_margin.icon_layout.icon:set_image(gears.color.recolor_image(
            icondir .. icon .. ".svg", color["Grey900"]))
        end
      )
    end
