    ...
    awful.spawn.easy_async_with_shell(
      ...
      function(stdout)
        if stdout:match("yes") then
          ...
          volume_osd_widget.container.osd_layout.icon_slider_layout.icon_margin1.icon_margin2.icon:set_image(icondir ..
            "volume-mute" .. ".svg")
        else
          awful.spawn.easy_async_with_shell(
            "./.config/awesome/scripts/vol.sh volume",
            function(stdout2)
              ...
              volume_osd_widget.container.osd_layout.icon_slider_layout.slider_layout.volume_slider:set_value(tonumber(
                stdout2))
              update_osd()
            end
          )
